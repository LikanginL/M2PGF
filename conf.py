...
parser.add_argument('--N-fold', default=1, type=int, help="the ratio of train and validation data")
parser.add_argument('-f','--fold', default=1, type=int, metavar='N', help='the fold of three folds cross-validation ')

# Param
parser.add_argument('-b','--batch-size', default=512, type=int, metavar='N', help='mini-batch size (default: 128)')#vox  64  linear 128
...
# Network and Loss
parser.add_argument('--resnet50', default='swin_transformer_base', type=str, choices=['resnet18', 'resnet50', 'resnet101',
...
#./napshots/resnet18base.pth
parser.add_argument('--resume', default='', type=str, metavar='path', help='path to latest checkpoint (default: none)')
parser.add_argument('--arc', default='resnet152', type=str, metavar='path', help='path to latest checkpoint (default: none)')
